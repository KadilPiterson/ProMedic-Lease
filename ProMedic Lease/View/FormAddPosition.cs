...
namespace ProMedic_Lease.View
{
    public partial class FormAddPosition : Form
    {
        ...
        public FormAddPosition(IServiceFacade serviceFacade)
        {
            InitializeComponent();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Position @new = _serviceFacade.PositionService.CreateFormData(txtName.Text);
            try
            {
                _serviceFacade.PositionService.Add(@new);
